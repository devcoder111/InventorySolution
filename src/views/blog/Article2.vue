      ...
      <v-row>
        ...
        >
          ...
          >
            ...
            >
              <v-img
                src="@/assets/images/blog_slider/iStock-937444320.jpg"
              ></v-img>
            </v-col>
          </v-row>
          <v-row>
          ...
          <v-row>
            ...
            >
              <p
                class="article-subtitle mb-12"
              >How does the iBuildApp Inventory Management (IM) App Template Work?</p>
              <p
                class="article-content"
              >
          ...
          <v-row>
            ...
            >
              <p
                class="article-content"
              >Building an IM app with iBuildApp can enable you to streamline key inventory management processes for your hospital.</p>
            </v-col>
            <v-col
              cols="12"
            >
          ...
          <v-row>
            ...
            >
              <p
                class="section-title"
              >● Push Notifications about inventory shortages and expiries</p>
              <p
                class="article-content"
          ...
          <v-row>
            ...
            >
              <p
                class="section-title"
              >● Spreadsheet formulas and barcode scanning for automated data input</p>
              <v-row>
                <v-col
                  cols="8"
                >
                  <v-img
                    src="@/assets/images/articles/spreadsheet_formulas.png"
                ...
                >
                  ...
                  <p class="article-content">
                    Building an app with the iBuildApp inventory template enables you to use formulas to calculate output using data from one or multiple spreadsheets
                  </p>
                </v-col>
              </v-row>
              <p
