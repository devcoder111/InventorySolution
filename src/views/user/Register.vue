      ...
      <v-col sm="12" md="12" cols="12">
        ...
        <v-row justify="center" class="signup-container">
          <v-col sm="12" md="4" lg="3" cols="12">
            <v-card align="center" class="signup-card">
              <RegisterForm class="signup-form" />
            </v-card>
          </v-col>
          <v-col
            sm="12"
...
.signup-card .social-button .button_login_new {
  cursor: pointer;
  padding: 0 !important;
...
.signup-card .social-button .button_login_new span {
    line-height: 48px;
    letter-spacing: 1px;
    font-size: 1rem;
    text-decoration: none;
