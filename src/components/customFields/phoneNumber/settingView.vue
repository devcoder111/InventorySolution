        ...
        <v-row>
          ...
          <v-col cols='12'>
            <div>
              ...
              />
              <span :class="$style['label-text']">Default number</span>
            </div>
            <div class='mt-2 input-box'>
              ...
              <span style="color: #7d7d7d">Set the default number to be shown for this field. This can be edited at any time.</span>
            </div>
            <div class='mt-2 input-box'>
              <v-text-field
                dense
