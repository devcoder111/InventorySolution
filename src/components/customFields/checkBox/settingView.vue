        ...
        <v-row>
          ...
          <v-col cols="12">
            <div>
              ...
              />
              <span :class="$style['label-text']">Default value</span>
            </div>
            <div class="mt-2 input-box">
              ...
              <span style="color: #7d7d7d"
                >Chose wether the checkbox will initially be active or not</span
              >
            </div>
            <div class="mt-2 input-box">
              <v-checkbox
...
export default {
  ...
  data: function () {
    return {
      ...
      itemType: 'checkBox',
      defaultValue: this.preloadedItem.value || false,
