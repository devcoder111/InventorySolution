      ...
      <v-form v-model='valid'>
        <v-row>
          ...
          <setting-field-row
            ...
            @inputEvent='newVal=>{defaultValue=newVal}'
          />
          <setting-field-row
            :cols='6'
            :name='"Unit Name"'
            :description='"The unit attribute specifies the measure of the curresponding value"'
            :placeholderContent='"Enter Unit Name(optional) ..."'
            :fieldType='"text"'
            v-model='units'
            @inputEvent='newVal=>{units=newVal}'
          />
          <setting-field-row
            :cols='12'
...
export default {
  ...
  data: function() {
    return {
      ...
      units: this.preloadedItem.units || '',
